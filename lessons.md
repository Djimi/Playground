...
- Before concluding an import has not happened, inspect all active Compose projects and worktree databases; the default project may be an older catalog while the enriched import lives in a separate stack.
